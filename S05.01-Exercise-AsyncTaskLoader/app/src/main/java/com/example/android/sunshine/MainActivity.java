...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private void loadWeatherData() {
        ...
        Loader<String[]> loader = loaderManager.getLoader(WEATHER_SEARCH_LOADER);
        showWeatherDataView();

        if(loader == null)
            loaderManager.initLoader(WEATHER_SEARCH_LOADER, null, this);
        else
            loaderManager.restartLoader(WEATHER_SEARCH_LOADER, null, this);
